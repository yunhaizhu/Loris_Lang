                                   ...
                                   IN std_int_t line)
{
    ...
    if ((!strcmp(s, "print") && std_safe_strlen(s, KEY_NAME_SIZE) == std_safe_strlen("print", KEY_NAME_SIZE)) ||
        (!strcmp(s, "eprint") && std_safe_strlen(s, KEY_NAME_SIZE) == std_safe_strlen("eprint", KEY_NAME_SIZE)) ||
        (!strcmp(s, "assert") && std_safe_strlen(s, KEY_NAME_SIZE) == std_safe_strlen("assert", KEY_NAME_SIZE)) ||
        (!strcmp(s, "start") && std_safe_strlen(s, KEY_NAME_SIZE) == std_safe_strlen("start", KEY_NAME_SIZE))) {
