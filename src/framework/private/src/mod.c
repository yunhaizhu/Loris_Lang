 ...
 * @brief   register instance function
 * @param   p_iid
 ...
 * @brief   unregister instance function
 * @param   p_iid
 * @return  STD_CALL std_rv_t
 */
 ...
 * @brief   create instance with iid string
 * @param   p_iid_string
 ...
 * @brief   delete instance with iid string
 * @param   p_iid_string
 * @param   p_iid_string_size
 * @param   pp_handle
 * @param   owner_obj
 ...
 * @brief   query instance with iid string
 * @param   p_iid_string
 * @param   p_iid_string_size
 * @param   pp_handle
 * @param   owner_obj
