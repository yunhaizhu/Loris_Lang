...
def level_order(var root, var result)
{
    var queue<>
    var root_string
    var level_size
    ...
    while (level_size > 0) {
        ...
        for (i = 0; i < level_size; i += 1) {
            ...
            current_level.add_item(node{"value"})
...
def main()
{
    ...
    level_order(binary_tree_head, result)

    print_result(result)
}

#script("script/leetcode/102_level_binary_tree.ll")
